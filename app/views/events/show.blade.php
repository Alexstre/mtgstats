...
@section('title')
    {{ $event->name }} from {{ date("d F Y", strtotime($event->played_on)) }}
@stop
@section('content')
    ...
    <div class="content-box-large">
        <div class="panel-heading">
            <div class="panel-title">
                <h2>{{ $event->name }} <small>{{ date("d F Y", strtotime($event->played_on)) }}</small></h2>
            </div>
        </div>
...
<div class="col-md-8">
    <div class="content-box-large">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped" id="tabCards">
                <thead>
                <tr>
                    <td>Name</td>
                    <td>Set</td>
